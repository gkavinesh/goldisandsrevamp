jQuery(document).ready(function($) {
    ...
    $('.open-menu').on('click', function(e) {
        ...
        $('.overlay-menu').toggleClass('expanded');
        var body = $('body');
    ...
    //this_document.scroll(function() {
    //    if (this_document.scrollTop() > 1024) {
    //        $('.footer-fix').hide();
    //    } else {
    //        $('.footer-fix').show();
    //    }
    ...
    $(".page-section-nav a:not(.external)").on("click", function(e) {
        e.preventDefault();
        $("body, html").animate({
    ...
    $('.scroll-menu-container a').on('click', function(e) {
        e.preventDefault();
        $("body, html").animate({
            scrollTop: $($(this).attr('href')).offset().top - 52
        }, 1000);
    ...
    $('.scroll-menu-container-aa a').on('click', function(e) {
        e.preventDefault();
        $("body, html").animate({
            scrollTop: $($(this).attr('href')).offset().top - 52
        }, 1000);
